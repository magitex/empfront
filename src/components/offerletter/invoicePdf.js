...
const InvoicePdf = (props) =>{
    return (
        <div>
                <div className="container-fluid"  ref={ref}>                      
                    ...
                    <div className='d-flex justify-content-between'>               
                        ...
                        <div className='innumber'>
                            ...
                            <h5>Bill To: {props.companyname}</h5>
                ...
                <div className="pdf">
                <Pdf targetRef={ref} filename="invoice.pdf" options={options} x={.5} y={.5} scale={0.8}>
                {({toPdf}) => (
...
//             </div> 
//             <div>
//     <ReactToPdf targetRef={ref} filename="invoice.pdf" options={options} >
//         {({toPdf}) => (
//             <button onClick={toPdf}>Generate pdf</button>
//         )}
//     </ReactToPdf>
